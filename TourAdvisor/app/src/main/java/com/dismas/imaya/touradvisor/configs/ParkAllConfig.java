...
public class ParkAllConfig {
    public static final String DATA_URL= "http://touradvisorzone.com/touradvisorphp/parks.php";
    public static final String RESERVE_URL= "http://touradvisorzone.com/touradvisorphp/reserves.php";
