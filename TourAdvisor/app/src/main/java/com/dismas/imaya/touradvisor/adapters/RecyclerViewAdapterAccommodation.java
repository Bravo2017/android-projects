...
public class RecyclerViewAdapterAccommodation extends RecyclerView.Adapter<RecyclerViewAdapterAccommodation.ViewHolder> {
    ...
    public RecyclerViewAdapterAccommodation(Context context, List<ParksAllConstructor> itemList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View layoutView = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_view_list_accommmodation, null);
