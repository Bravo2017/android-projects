...
import com.dismas.imaya.bash.extractor.Parser;
...
public class ErrorActivity extends AppCompatActivity {
    ...
    public static final String ERROR_EMAIL_ADDRESS = "imayadismas@gmail.com";
    public static final String ERROR_EMAIL_SUBJECT = "Exception in Fan4Fun " + BuildConfig.VERSION_NAME;
