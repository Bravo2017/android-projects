...
public class Collect extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private void saveFarmDatatoSQLiteDB() {
        restClient.getService().getObjectWithNestedArraysAndObject(new Callback<FarmData>() {
            ...
            public void failure(RetrofitError error) {
                Toast.makeText(Collect.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });
    }
